            ...
            <nav class="flex-1 overflow-y-auto p-4">
                <ul class="space-y-1">
                    ...
                    <?php if ($auth->hasRole(['Admin', 'Officer'])): ?>
                        ...
                        <li>
                            <a href="<?php echo BASE_URL; ?>/views/admin/document_submissions.php" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
